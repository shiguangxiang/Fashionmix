...
public class LoadMoreRecyclerView extends RecyclerView {
    ...
    private BaseOnScrollListener onScrollListener;
    ...
    /**
     * 下拉刷新后用来更新adapter的数据。因为该类对adapter进行的包装，需要用AutoLoadAdapter来更新状态
     *
     * @param ptrClassicFrameLayout 下拉刷新控件  通知下拉刷新已完成
     */
    public void refreshComplete(PtrClassicFrameLayout ptrClassicFrameLayout, boolean hasMore) {
    ...
    public interface BaseOnScrollListener{
        void onScrollListener();
    }

    public void setOnScrollListener(BaseOnScrollListener onScrollListener){
